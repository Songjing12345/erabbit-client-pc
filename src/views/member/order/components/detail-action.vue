  ...
  <div class="detail-action">
    ...
    <div class="btn">
      ...
      <template v-if="order.orderState === 1">
        ...
        <XtxButton @click="handelCancel(order)" type="gray" size="small">取消订单</XtxButton>
      </template>
      <!-- 待发货 -->
      ...
      <template v-if="order.orderState === 4">
        ...
        <XtxButton @click="$router.push(`/member/checkout?orderId=${order.id}`)" type="gray" size="small">申请售后</XtxButton>
      </template>
      <!-- 已完成 -->
