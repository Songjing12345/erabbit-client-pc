<template>
  <div class="goods-comment">
    ...
    <!--  分页组件-->
    <XtxPagination v-if="total" @current-change="changePagerFn" :page-size="reqParams.pageSize" :current-page="reqParams.page"></XtxPagination>
  </div>
</template>
<script>
...
export default {
  ...
  setup (props) {
    ...
    return { commentInfo, currTagIndex, changeTag, reqParams, commentList, changeSort, formatSpecs, formatNickname, total, changePagerFn }
  }
}
</script>
